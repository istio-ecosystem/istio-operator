...
_GLOBALCONFIG = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='podDNSSearchNamespaces', full_name='v1alpha1.GlobalConfig.podDNSSearchNamespaces', index=41,
