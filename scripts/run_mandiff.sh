...
mesh_mandiff_with_profile ${ISTIO_DEFAULT_PROFILE} > .mandiff-default-profile.diff || echo "default profile has diffs"
mesh_mandiff_with_profile ${ISTIO_DEMO_PROFILE} > .mandiff-demo-profile.diff || echo "default profile has diffs"
mesh_mandiff_with_profile ${ISTIO_DEMOAUTH_PROFILE} > .mandiff-demoauth-profile.diff || echo "default profile has diffs"
mesh_mandiff_with_profile ${ISTIO_MINIMAL_PROFILE} > .mandiff-minimal-profile.diff || echo "default profile has diffs"
mesh_mandiff_with_profile ${ISTIO_SDS_PROFILE} > .mandiff-sds-profile.diff || echo "default profile has diffs"
